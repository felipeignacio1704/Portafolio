                ...
                <div className="px-4 w-100">
                    ...
                    <form action="https://formsubmit.co/naranjolopezfelipe@gmail.com" method="POST" className="space-y-6">
                        ...
                        <div className="relative">
                            <input type="text" id="name" name="name" placeholder="Su nombre" required className="w-full bg-white/10 border border-r-white rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5" />
                        </div>
                        {/* correo */}
                        <div className="relative">
                            <input type="email" id="email" name="email" placeholder="Tu correo Ejemplo@gmail.com" required className="w-full bg-white/10 border border-r-white rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5" />
                        </div>
                        {/* asunto */}
                        <div className="relative">
